...
class GlobalConfigRepositoryTest {
    ...
    @Test
    fun `getEffectiveAiTutorApiKey returns feature key when available`() = runTest {
    ...
    @Test
    fun `getEffectiveAiTutorApiKey returns general key when feature key is empty`() = runTest {
    ...
    @Test
    fun `getEffectiveAiTutorApiKey returns default key when both are empty`() = runTest {
        whenever(preferencesManager.getString("api_key_ai_tutor", "")).thenReturn(flowOf(""))
    ...
    @Test
    fun `getEffectiveTimelineMapApiKey returns feature key when available`() = runTest {
    ...
    @Test
    fun `getEffectiveTimelineMapApiKey returns default key when both are empty`() = runTest {
    ...
    @Test
    fun `getEffectiveVideoSummaryApiKey returns feature key when available`() = runTest {
    ...
    @Test
    fun `getEffectiveVideoSummaryApiKey returns default key when both are empty`() = runTest {
    ...
    @Test
    fun `getBailianApiKey returns correct flow`() = runTest {
    ...
    @Test
    fun `saveAiTutorBaseUrl calls preferencesManager`() = runTest {
        repository.saveAiTutorBaseUrl("new_url")
        verify(preferencesManager).saveString("base_url_ai_tutor", "new_url")
    }

    @Test
    fun `getAiTutorModelName returns correct flow`() = runTest {
        whenever(preferencesManager.getString("model_name_ai_tutor", AppConstants.DEFAULT_MODEL_NAME)).thenReturn(flowOf("custom_model"))
    ...
    @Test
    fun `saveUserNickname calls preferencesManager`() = runTest {
        repository.saveUserNickname("NewUser")
        verify(preferencesManager).saveString("user_nickname", "NewUser")
    }

    @Test
    fun `getTimelineMapBaseUrl returns correct flow`() = runTest {
    ...
    @Test
    fun `saveTimelineMapBaseUrl calls preferencesManager`() = runTest {
        repository.saveTimelineMapBaseUrl("new_url")
        verify(preferencesManager).saveString("base_url_timeline_map", "new_url")
    }

    @Test
    fun `getTimelineMapModelName returns correct flow`() = runTest {
        whenever(preferencesManager.getString("model_name_timeline_map", AppConstants.DEFAULT_MODEL_NAME)).thenReturn(flowOf("custom_model"))
    ...
    @Test
    fun `saveVideoSummaryBaseUrl calls preferencesManager`() = runTest {
        repository.saveVideoSummaryBaseUrl("new_url")
        verify(preferencesManager).saveString("base_url_video_summary", "new_url")
    }

    @Test
    fun `getVideoSummaryModelName returns correct flow`() = runTest {
        whenever(preferencesManager.getString("model_name_video_summary", AppConstants.DEFAULT_MODEL_NAME)).thenReturn(flowOf("custom_model"))
    ...
    @Test
    fun `saveCurrentUserId calls preferencesManager`() = runTest {
        repository.saveCurrentUserId("user_123")
        verify(preferencesManager).saveString("current_user_id", "user_123")
    }

    @Test
    fun `getUserSignature returns correct flow`() = runTest {
    ...
    @Test
    fun `saveUserSignature calls preferencesManager`() = runTest {
