...
@Singleton
class BailianSummaryRepository
    @Inject
    constructor(
        ...
        private suspend fun scanLocalNetwork(): String? =
        ...
        private suspend fun checkEndpoints(
            urls: List<String>,
            timeoutMs: Long,
        ): String? =
            withContext(dispatcherProvider.io) {
        ...
        suspend fun transcribeOffline(file: File): Result<String> =
            withContext(dispatcherProvider.io) {
        ...
        suspend fun uploadToTemporaryStorage(
            apiKey: String,
            file: File,
        ): Result<String> =
            withContext(dispatcherProvider.io) {
            ...
            withContext(dispatcherProvider.io) {
                ...
                return@withContext try {
                    ...
                    val transcriptionUrl =
                        transcriptionUrlResult.getOrElse {
        ...
        suspend fun summarize(
            apiKey: String,
            transcript: String,
            modelName: String = com.example.common.config.AppConstants.DEFAULT_MODEL_NAME,
            baseUrl: String = com.example.common.config.AppConstants.BASE_URL,
        ): Result<String> =
            withContext(dispatcherProvider.io) {
        ...
        private suspend fun pollTranscriptionUrl(
            service: BailianAsrService,
            taskId: String,
        ): Result<String> {
            repeat(60) {
        ...
        private fun requestUploadPolicy(
            apiKey: String,
            model: String,
        ): Result<UploadPolicy> {
            ...
            return try {
                httpClient.newCall(request).execute().use { response ->
                    ...
                    val responseBody = response.body?.string() ?: throw java.io.IOException("Empty response body")
                    ...
                    val securityToken =
                        extractString(data, "security_token", "securityToken").ifBlank {
        ...
        private val reservedUploadFields =
            setOf(
                "key",
                "policy",
                "OSSAccessKeyId",
        ...
        private val reservedPolicyKeys =
            setOf(
                "host",
                "upload_host",
                "dir",
