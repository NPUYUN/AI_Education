...
class TextSummaryViewModelTest {
    ...
    @Test
    fun `summarize successful updates summaryResult`() = runTest(testDispatcher) {
    ...
    @Test
    fun `summarize failure sets error`() = runTest(testDispatcher) {
        val inputText = "Some text"
    ...
    @Test
    fun `handleFileUri success updates inputText`() = runTest(testDispatcher) {
        val uri = mock<Uri>()
    ...
    @Test
    fun `handleFileUri failure sets error`() = runTest(testDispatcher) {
        val uri = mock<Uri>()
